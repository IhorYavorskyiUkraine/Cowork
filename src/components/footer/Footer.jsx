            ...
            <div className="container">
               <div className="footer-cowork">
                  <div className="footer-cowork__main">
                     ...
                     <p className="footer-cowork__label text">
                        Join our newsletter to stay up to date on features and
                        releases.
                     </p>
                     <form action="submit" className="footer-cowork__form">
                        <input
                           type="text"
                        ...
                        <div className="footer-cowork__btn">
                           <button className="footer-cowork__button btn">
                              <span>Subscribe</span>
                           </button>
                        </div>
                     </form>
                     <p className="footer-cowork__agree text">
                  ...
                  <div className="footer-cowork__columns">
                     ...
                     <div className="footer-cowork__column">
                        <div className="footer-cowork__title">
                           Stay Connected
                        </div>
                        <ul className="footer-cowork__links">
                           <li className="footer-cowork__link">
               ...
               <div className="footer-rights">
                  <div className="footer-rights__columns">
                     <div className="footer-rights__column">
                        <p className="footer-rights__rights">
