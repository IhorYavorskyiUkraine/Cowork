         ...
         return (
            <li key={item.id} className="blog__item blog-item">
               <div className="blog-item__wrapper">
                  ...
                  <Link to={`/blog/${item.id}`} className="blog-item__more">
                     Read More
                  </Link>
               </div>
            </li>
               ...
               <div className="container">
                  <div className="blog__content">
                     <div className="blog__filters">
                        ...
                        <button
                           className="blog__filter btn"
                           onClick={() => handleFilter("Productivity")}
                        >
                           <span>Productivity</span>
                        </button>
                        <button
                           className="blog__filter btn"
                           onClick={() => handleFilter("Talk")}
                        >
                           <span>Talk</span>
                        </button>
                     </div>
