				...
				<section className="blogPage">
					<div className="container">
						<div className="blogPage__wrapper">
							<Link to="/blog" className="back"><img src={back} className="back-img" alt="back"/>Back</Link>
							<div className="blogPage__content">
								<div className="blogPage__column">
									...
									<p className="blogPage__category" style={{background: `${data.style}`}}>{data.category}</p>
								</div>
								<div className="blogPage__column">
									<h1 className="blogPage__title title">{data.title}</h1>
