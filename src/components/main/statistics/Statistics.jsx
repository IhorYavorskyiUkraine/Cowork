            ...
            <div className="container">
               <div className="statistics__content">
                  <motion.div
                     ...
                     viewport={{ once: true }}
                  >
                     <p className="statistics__label label">
                        Cowork in Numbers
                     </p>
                     <h2 className="statistics__title title">
                     ...
                     <div className="statistics__items">
                        <div className="statistics__item item-statistics">
                           <h3 className="item-statistics__num title title">
                              240%
                           </h3>
                           <p className="item-statistics__text text">
                              Community Growth
                           </p>
                        </div>
                        <div className="statistics__item item-statistics">
