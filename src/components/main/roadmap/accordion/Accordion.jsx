...
const AccordionComponent = () => {
   return (
      <Accordion allowZeroExpanded preExpanded={["a"]} className="accordion">
         <AccordionItem uuid="a" className="accordion__item">
            <AccordionItemHeading className="accordion__heading">
               <AccordionItemButton className="accordion__button">
                  <span>How flexible are Cowork's membership plans?</span>
         ...
         <AccordionItem className="accordion__item">
            <AccordionItemHeading className="accordion__heading">
               <AccordionItemButton className="accordion__button">
                  <span>
                     What kind of events and networking opportunities does
                     Cowork provide?
                  </span>
                  <img src={img} alt="button" />
               </AccordionItemButton>
            ...
            <AccordionItemPanel className="accordion__panel text">
               <p>
                  ...
                  Obcaecati voluptas, possimus dicta, nemo ut non vero maiores
                  iste hic quas illo, velit nisi vel quisquam maxime magnam
                  totam iusto eligendi?
               </p>
            </AccordionItemPanel>
         </AccordionItem>
         <AccordionItem className="accordion__item">
            <AccordionItemHeading className="accordion__heading">
               <AccordionItemButton className="accordion__button">
                  <span>
                     Can I tour the Cowork space before committing to a
                     membership?
                  </span>
                  <img src={img} alt="button" />
               </AccordionItemButton>
